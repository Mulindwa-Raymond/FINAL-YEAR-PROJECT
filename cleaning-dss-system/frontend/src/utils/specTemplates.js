/**
 * specTemplates.js
 * Defines default attribute templates for each (category + intensity + sub-type) combination.
 * Used to pre-populate Equipment Specifications when creating a new equipment.
 * 
 * NEW: Added filtration_type, brush_type, upholstery_attachment templates.
 */
...
export const floorScrubberTemplates = {
  light: {
    walk_behind: [
      ...
      { attribute_name: 'brush_type', attribute_value: 'disc', unit_of_measure: null, required: false, description: 'Type of brush (disc, cylindrical, both)' },
  ...
  heavy: {
    walk_behind: [
      ...
      { attribute_name: 'brush_type', attribute_value: 'cylindrical', unit_of_measure: null, required: false, description: 'Type of brush (disc, cylindrical, both)' },
...
// ============================================
// VACUUM CLEANER TEMPLATES (with filtration and upholstery)
// ============================================

export const vacuumCleanerTemplates = {
  light: {
    wet_dry: [
      ...
      { attribute_name: 'filtration_type', attribute_value: 'standard', unit_of_measure: null, required: false, description: 'HEPA level for dust filtration' },
      { attribute_name: 'upholstery_attachment', attribute_value: 'false', unit_of_measure: null, required: false, description: 'Includes upholstery/stair cleaning attachment' },
    ...
    backpack: [
      ...
      { attribute_name: 'filtration_type', attribute_value: 'HEPA_H13', unit_of_measure: null, required: false, description: 'HEPA level for dust filtration' },
  ...
  medium: {
    wet_dry: [
      ...
      { attribute_name: 'filtration_type', attribute_value: 'HEPA_H13', unit_of_measure: null, required: false, description: 'HEPA level for dust filtration' },
      { attribute_name: 'upholstery_attachment', attribute_value: 'true', unit_of_measure: null, required: false, description: 'Includes upholstery/stair cleaning attachment' },
    ...
    industrial: [
      ...
      { attribute_name: 'filtration_type', attribute_value: 'HEPA_H14', unit_of_measure: null, required: true, description: 'HEPA level for dust filtration' },
  ...
  heavy: {
    industrial: [
      ...
      { attribute_name: 'filtration_type', attribute_value: 'absolute', unit_of_measure: null, required: true, description: 'Filtration level (standard, HEPA_H13, HEPA_H14, absolute)' },
...
// ============================================
// PRESSURE WASHER TEMPLATES (keep as is, no new fields)
// ============================================

export const pressureWasherTemplates = {
  light: {
    electric: [
...
export const getSpecTemplate = (category, intensity, subtype) => {
  let template = [];
